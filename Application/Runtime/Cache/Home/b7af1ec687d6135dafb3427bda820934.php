...
<head>
    ...
    <link href="/Public/Home/css/tixian.css" rel="stylesheet" type="text/css" />
</head>
<body id="content">
<header>
    <div class="rt-bk">
    ...
    <div class="top-name"><p>现金提现</p></div>
            ...
            <li style="margin: 0.2rem auto">
                <div class="querytitle">
                    ...
                    <div class="toolmiddle">
                        <input class="input_cz" type="text" placeholder="请输入提现金额"/>
                    </div>
                    <div class="toolright">
                        元
                    </div>
            ...
            <a href="#">
                <li>
                    <div class="querytitle">
                        ...
                        <div >
                            <p style="float: left;width: 54%;margin-left: 1%;font-size: 0.25rem;color: darkgray;margin-top: 0.05rem;text-align: right">请选择开户行 </p>
                        </div>
                        <div class="toolright">
                            >
                        </div>
