...
<div class="jumplist">
    <ul style="list-style-type:none;padding-left: 0;margin-top: 0;">
        <li>
            <a style=" text-decoration:none; color:#9d9d9d" href="<?php echo U("edit_fdname");?>">
        ...
        <li>
            <a style=" text-decoration:none; color:#9d9d9d" href="<?php echo U("edit_fdtel");?>">
            <div class="querytitle">
                <div class="toolleft">
                    手机号
                </div>
        ...
        <li>
            <a style=" text-decoration:none; color:#9d9d9d" href="<?php echo U("fd_fy");?>">
            <div class="querytitle">
                <div class="toolleft">
                    房源
                </div>
        ...
        <li>
            <a style=" text-decoration:none; color:#9d9d9d" href="<?php echo U("my_wallet");?>">
            <div class="querytitle">
                <div class="toolleft">
                    我的钱包
                </div>
